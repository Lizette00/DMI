...
<body class="" style="background-image: url(assets/images/uni.jpg);
        ...
        <div class="login-bg-color">
            <div class="row">
                <div class="col-md-4 col-md-offset-7">
                    <div class="panel login-box" style="    background: #4c731f;">
                        <div class="panel-heading">
                            <div class="panel-title text-center">
                                <a href="#">
                                    <img style="height: 70px" </a>
                        ...
                        <div class="panel-body p-20">
                            ...
                            <form action="result.php" method="post" class="admin-login">
                                ...
                                <div class="col-sm-6">
                                    <a href="Casa.html" class="text-white">Volver</a>
                                </div>
                            </form>
